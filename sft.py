...
def parse_args():
    ...
    parser.add_argument(
        "--flash_attn", type=bool, default=True, help="Whether to use flash attention."
    )
    parser.add_argument(
...
def main():
    args = parse_args()
    # args.output_dir = args.output_dir + '/' + args.optimizer + str(args.gradient_accumulation_steps)
